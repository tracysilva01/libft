...
#    Updated: 2025/01/28 13:53:46 by trsilva-         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS =	ft_isalpha.c ft_isdigit.c ft_isalnum.c ft_isascii.c ft_isprint.c \
		...
		ft_strjoin.c ft_strlcat.c ft_strnstr.c \
		ft_calloc.c ft_itoa.c ft_striteri.c ft_strmapi.c

# falta añadir: ft_strtrim.c ft_substr.c 
# Object files
OBJ = $(SRCS:.c=.o)
